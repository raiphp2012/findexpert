...
if( !empty($users_result['error']) ) {
  if( !empty($users_result['error']['message']) ) {
    ?>
    <div class="wrap">
            ...
            <div class="inside">
              <table>
                <tr>
                  ...
                  <td><input type="password" name="zoom_api_key" id="zoom_api_key" value="<?php echo (get_option('zoom_api_key')) ? get_option('zoom_api_key') : '' ; ?>"> <small>Required</small> <a href="#" onclick="toggle_password_api('zoom_api_key');" id="showhide">Show</a></td>
                </tr>
                <tr>
                  <th><?php _e('API Secret Key :', 'video-conferencing-with-zoom-api'); ?></th>
                  <td><input type="password" name="zoom_api_secret" id="zoom_api_secret" value="<?php echo (get_option('zoom_api_secret')) ? get_option('zoom_api_secret') : '' ; ?>"> <small>Required</small> <a href="#" onclick="toggle_password_secret('zoom_api_secret');" id="showhide1">Show</a></td>
                </tr>
              </table>
            </div>
          </div>
