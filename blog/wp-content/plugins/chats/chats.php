...
if ( ! class_exists( 'Chats' ) ) {
    ...
    class Chats
    {
        ...
        public static function js_process(){
            ...
            if( $mode == 'add' and !empty($message) ){
                ...
                if($addRes){
                    ...
                    self::send_messages($hash, $ip, $browser, $message, $created, $message_page, $currentUserID, $user_timezone, $server_timezone, $user_name, $user_email);
                }
         ...
         */
        public static function send_messages($hash, $ip, $browser, $message, $created, $message_page = '', $currentUserID = 0, $user_timezone = 0, $server_timezone = 0, $user_name='', $user_email=''){
                ...
                if( !empty($messages) ){
                    foreach($messages as $k_item => $v_item){
                        ...
                        $list[] = array(
                            ...
                            'text'          => nl2br(htmlentities($v_item->message)),
                            'time'          => $time,
