...
class facebook_comments_master_widget_viral extends WP_Widget {
	...
	//Display Viral Buttons
		echo '<div id="fb-root"></div>' .
			...
			'js.src = "//connect.facebook.net/'.$facebook_comments_master_wv_lang_create.'/sdk.js#xfbml=1&version=v2.7'.$facebook_comments_master_wv_app_create.'";' .
			...
			'<div class="fb-like" data-href="'.$facebook_comments_url.'" data-layout="button_count" data-action="like" data-size="small" data-show-faces="false" data-share="true"></div>' .
	$after_widget;
	}
	//Update the widget
