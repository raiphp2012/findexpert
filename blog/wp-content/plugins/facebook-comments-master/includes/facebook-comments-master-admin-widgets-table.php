...
<table class="widefat" cellspacing="0">
	...
	<tbody>
		<tr class="alternate">
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-facebookcommentsmaster-admin-widget-viral.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('facebook_comments_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
		...
		<tr>
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-facebookcommentsmaster-admin-widget-basic.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('facebook_comments_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
		...
		<tr class="alternate">
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-facebookcommentsmaster-admin-widget-advanced.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('facebook_comments_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
			<td style="vertical-align:middle"><h3>Facebook Comments Master Advanced Responsive Widget</h3><p>This is the "top of the line" Facebook Comments Widget specially designed for heavy duty professional wordpress websites where fast page load times, stability and perfect Google SEO is a must.</p><p>Coded in html5 it's packed with display options and is <b>Fully Mobile Responsive</b>.</p><p>Check Add-ons Page.</p></td>
		</tr>
		<tr>
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-admin-widget-blank.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('amazon_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
