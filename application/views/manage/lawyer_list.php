      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="panel panel-default">
            ...
            <form name="frmCASearch" id="frmCASearch" method="get" action="<?php echo base_url('manage/admin/lawyer_list');?>">
                        <label>Name:
              ...
              <td><?php echo $location_info->locationName;?></td>
               ...
               <td><input type="text" name="sortBy[]" id="sort-<?php echo $ca_info->expertId;?>" value="<?php echo $ca_info->sortBy;?>" class="form-control sort-order"/></td>
                ...
                <td><input type="checkbox" name="isVerified[]" id="verified-<?php echo $ca_info->expertId;?>" value="1" class="verified" <?php if($ca_info->isVerified){echo "checked";}?> /></td>
							...
							<td><a href="<?php echo base_url('manage/admin/lawyer/id/'.$ca_info->expertId);?>">View</a> | <a href="<?php echo base_url('manage/admin/appointment_list?expertId='.$ca_info->expertId);?>">Appointment</a> | <a href="<?php echo base_url('manage/admin/delete_lawyer/id/'.$ca_info->expertId);?>" onClick="return confirm('Are you sure to delete the Lawyer ?')">Delete</a></td>
