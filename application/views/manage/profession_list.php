            ...
            <div class="row">
                    ...
                    <div class="col-sm-12">
                      ...
                      <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
						...
						foreach($results as $category_info){
              ?>

                          <tr class="gradeA odd" role="row">

                            <td><?php echo $category_info->categoryName;?></td>

							<td><a href="<?php echo base_url('manage/admin/service_list?categoryId='.$category_info->categoryId);?>">Services</a> | <a href="<?php echo base_url('manage/admin/profession/id/'.$category_info->categoryId);?>">Edit</a> | <a href="<?php echo base_url('manage/admin/delete_profession/id/'.$category_info->categoryId);?>" onClick="return confirm('Are you sure to delete the category ?')">Delete</a></td>
