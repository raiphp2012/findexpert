      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="panel panel-default">
            ...
            <form name="frmCASearch" id="frmCASearch" method="get" action="<?php echo base_url('manage/admin/ca_list');?>">
                        <label>Name:
              ...
              ?>
               ...
               <td><input type="text" name="sortBy[]" id="sort-<?php echo $ca_info->expertId;?>" value="<?php echo $ca_info->sortBy;?>" class="form-control sort-order"/></td>
                ...
                <td><input type="checkbox" name="isVerified[]" id="verified-<?php echo $ca_info->expertId;?>" value="1" class="verified" <?php if($ca_info->isVerified){echo "checked";}?> /></td>
							...
							<td><a href="<?php echo base_url('manage/admin/expert_detail/id/'.$ca_info->expertId);?>">Edit</a> | <a href="<?php echo base_url('manage/admin/appointment_list?expertId='.$ca_info->expertId);?>">Appointment</a> | <a href="<?php echo base_url('manage/admin/delete_ca/id/'.$ca_info->expertId);?>" onClick="return confirm('Are you sure to delete the CA ?')">Delete</a></td>
