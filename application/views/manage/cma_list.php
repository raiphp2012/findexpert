      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="panel panel-default">
            ...
            <form name="frmCASearch" id="frmCASearch" method="get" action="<?php echo base_url('manage/admin/cma_list');?>">
                        <label>Name:
 ...
 $location_info = $this->common->select_scaler_where("location",array("locationId"=>$ca_info->locationId));
              ...
              <td><?php echo $location_info->locationName;?></td>
                ...
                <td><input type="checkbox" name="isVerified[]" id="verified-<?php echo $ca_info->expertId;?>" value="1" class="verified" <?php if($ca_info->isVerified){echo "checked";}?> /></td>
							...
							<td><a href="<?php echo base_url('manage/admin/cma/id/'.$ca_info->expertId);?>">View</a> | <a href="<?php echo base_url('manage/admin/appointment_list?expertId='.$ca_info->expertId);?>">Appointment</a> | <a href="<?php echo base_url('manage/admin/delete_cma/id/'.$ca_info->expertId);?>" onClick="return confirm('Are you sure to delete the CMA ?')">Delete</a></td>
