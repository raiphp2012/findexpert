                ...
                <div class="row">
                    <div class="col-sm-12 transaction-reciept">
                        ...
                        <table class="table-txn-reciept">
                               <tr>
                                    <th> ID</th>
                                    <td class="receiptId"> <?php echo $txn_id; ?></td>
                                </tr>
                        ...
                        <div class="col-sm-12 update-no">
                            <form method="POST" action="https://secure.payu.in/_payment">
                                ...
                                <input type="hidden"  name="surl" value="<?php echo base_url(); ?>Ajaxcalls/payu_action_taken_success" size="64" />
                                <input type="hidden"  name="furl" value="<?php echo base_url(); ?>Ajaxcalls/payu_action_taken_failed" size="64" />
