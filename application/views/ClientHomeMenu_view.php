                            ...
                            <div class="row row-mar">
                                ...
                                <div class="hovereffect">
                                    ...
                                    <div class="overlay">
                                       ...
                                       <a class="info" href="<?php echo base_url("expert/chartered-accountant");?>">
                                           <h3>Connect Now</h3>
                                           <p>
                                           <i class="material-icons video-icon">video_call</i>
                                           <i class="material-icons phone-icon">contact_phone</i></p>
                                ...
                                <div class="hovereffect">
                                    ...
                                    <div class="overlay">
                                       ...
                                       <a class="info" href="<?php echo base_url("expert/company-secretary");?>">
                                            <h3>Connect Now</h3>
                                            <p>
                                           <i class="material-icons video-icon">video_call</i>
                                           <i class="material-icons phone-icon">contact_phone</i></p>
                            ...
                            <div class="row">
                                ...
                                <div class="hovereffect">
                                    ...
                                    <div class="overlay">
                                       ...
                                       <a class="info" href="<?php echo base_url("expert/certified-management-accountant");?>">
                                           <h3>Connect Now</h3>
                                           <p>
                                           <i class="material-icons video-icon">video_call</i>
                                           <i class="material-icons phone-icon">contact_phone</i></p>
                                ...
                                <div class="hovereffect">
                                    ...
                                    <div class="overlay">
                                       <h2>Lawyer</h2>
                                       <a class="info" href="<?php echo base_url("expert/lawyer");?>">
                                           <h3>Connect Now</h3>
                                           <p>
                                           <i class="material-icons video-icon">video_call</i>
                                           <i class="material-icons phone-icon">contact_phone</i></p>
