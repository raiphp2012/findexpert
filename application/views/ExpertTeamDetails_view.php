                                    ...
                                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                               ...
                                               <td><?php echo $teamMemberDetails->expertMobileNumber;?>
                                                ...
                                                <td><a href="javascript:void(0)" data-id="<?php echo $teamMemberDetails->expertId;?>" data-value="<?php echo $teamMemberDetails->expertName; ?>" onclick="openModal(this)"> View/Edit</a>&nbsp;|&nbsp;												<a onclick="return confirm('Are you to delete the member ?')" href="<?php echo base_url("ExpertProfile/delete_member/?member_id=".$teamMemberDetails->expertId);?>">Delete</a></td>
                                            </tr>
                                           <?php } } ?>
                                        </tbody>
                                    </table>
