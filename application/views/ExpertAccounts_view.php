                                    ...
                                    <div class="panel panel-default">
                                            <table class="table" style="width:100%;"> 
                                                ...
                                                <?php 
                                                 ...
                                                 ?>
                                                <tr>
                                                        <td><?php echo $details[$i]->appointmentId; ?></td> 
                                                        <td><?php echo $details[$i]->appointmentDate; ?></td> 
                                                        <td><?php echo $details[$i]->clientName; ?></td> 
                                                        <td><?php echo $details[$i]->consultationTypeName; ?></td> 
                                                       
                                                        <td><?php echo $details[$i]->consultationStatusName; ?></td> 
                                                        <td><?php echo $details[$i]->amountPaid; ?></td> 
