                            ...
                            <div class="tab-pane active">
                                <div class="main-content detail-view">
                                    <div class="detail-view-cont">
                                        ...
                                        <form class="form-horizontal" method="post" action="<?php echo base_url();?>MyOffice/new_leave_details" enctype="multipart/form-data">
                                       
                                            <fieldset>
                                                <div id="personalDataTab">
                                                    <!-- Form Name -->
                                                     <div class="col-md-12 form-wrapper">
                                                    <div class="alert alert-info text-center">Leaves</div>
                                                    <div class="form-group">
                                                           <label class="col-md-4 control-label" for="textinput">Staff Name</label>  
                                                                    <div class="col-md-8">
                                                                    <select class="form-control" name="stuff_id">

                                                                        <?php for ($i=0; $i <count($staff_details) ; $i++) { 
                                                                            ?>
                                                                            <option value="<?php echo $staff_details[$i]->stuff_id; ?>" ><?php echo $staff_details[$i]->stuff_name; ?></option>
                                                                          <?php  
                                                                        } ?>
