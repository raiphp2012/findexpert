                ...
                <div>
                    ...
                    <table style="text-align: left;border:1px solid #ccc;width: 100%;border-collapse: collapse;margin: 20px 0;">
                        <tbody>
                            ...
                            <tr style="border:1px solid #ccc;">
                                <th  style="color:#5f9ea0;font-size:18px;font-family: 'Roboto', sans-serif;padding: 5px 20px;border-right: 1px solid #ccc;width:50%;font-weight: 200;">Consulting Expert</th>
