    ...
    <body class="index-page">
        ...
        <section class="wide">
            <div class="container">
                ...
                <div class="row">
                    <h3 class="bannerHead">Our Panel of Experts</h3>
                </div>
                <div class="row" style="padding-bottom: 10px;">
                    <div class="col-xs-6 col-sm-3">
                        <div class="bannerSquareBox eqHt">
                            <div class="bannerSquareLogo">
                                <a href="Expertdetails">
                                    <img src="<?php echo base_url(); ?>assets1/img/logo_ca.svg" alt="CA Logo" ></a>
                            </div>
                    ...
                    <div class="col-xs-6 col-sm-3">
                        <div class="bannerSquareBox eqHt">
                            <div class="bannerSquareLogo">
                                <a href="Expertdetails"><img src="<?php echo base_url(); ?>assets1/img/logo_cs.svg" alt="CS Logo" ></a>
                            </div>
                    ...
                    <div class="col-xs-6 col-sm-3">
                        <div class="bannerSquareBox eqHt">
                            <div class="bannerSquareLogo">
                                <a href="Expertdetails"><img src="<?php echo base_url(); ?>assets1/img/logo_cma.png" alt="CMA Logo" ></a>
                            </div>
                    ...
                    <div class="col-xs-6 col-sm-3">
                        <div class="bannerSquareBox eqHt">
                            <div class="bannerSquareLogo">
                                <a href="Expertdetails"><img src="<?php echo base_url(); ?>assets1/img/logo_law.svg" alt="Lawyer Logo" ></a>
                            </div>
        ...
        <!-- expertConsultancy start -->

        <section id="expertConsultancy" class="redColor textcenter">
            <div class="container">
        ...
        <section id="waitInQueue" class="textcenter padding40" style="background-color: #fff">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a href="https://www.countmagic.com/user/guest/login" target="_blank">
                            <div class="tax-block-wrapper">
                                <h3>Free GST Return</h3>
                                
                            </div>
                        </a>
                        <a href="http://www.visheshagya.in/Expert" target="_blank">
                            <div class="tax-block-wrapper">
                                <h3>CA/Lawyer Panel</h3>
                            </div>
                        </a>
                         <br/>
                        <a href="https://www.countmagic.com/gst/user/login" target="_blank">
                            <div class="tax-block-wrapper">
                                <h3>GST Services</h3>
                            </div>
                        </a>
                       
                        <a href="http://www.vjobs.in/" target="_blank">
                            <div class="tax-block-wrapper">
                                <h3>VJobs</h3>
                            </div>
                        </a>
        ...
        <section id="whyVishesagya">
                ...
                <div class="row  row-pad">
                    <div class="col-md-6 text-center">
                        <div class="service-box">
                            ...
                            <p>Certified & Verified Experts (CA/CS/CMA/Lawyers)</p>
                        </div>
                    </div>
                    <div class="col-md-6 text-center">
                        <div class="service-box">
                            <div class="serviceIcon">
                                <img src="<?php echo base_url(); ?>assets1/img/webcam.svg" alt="Experts"  style="height: 171px;">
                            </div>
                            <h3>Audio &amp; Video Consultation<br>Anytime! Anywhere!</h3>
                            <p>Conveniently & Comfortably from your home/office even on the Move/Go</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 text-center">
                        <div class="service-box">
                            ...
                            <h3>Work Smarter & Achieve More</h3>
                            <p>Save on travel time &amp; expenses,Schedule appointments,Manage your calendar</p>
                        </div>
                    </div>
                    <div class="col-md-6 text-center">
                        <div class="service-box">
                            ...
                            <p>Save, View, Organise, Access, Share documents anytime</p>
                        </div>
                    </div>
                </div>
            </section><!-- Why Visheshagya end -->

            <!-- How it Works block -->

            <section id="whyVishesagya" style="background-color: #fff">
                <article class="container you-videos" style="padding: 0">
                    <h3>How it Works</h3>
                    <div class="row">
                       <div class="col-md-6">
                ...
                <div class="rowGap">&nbsp;</div>
            </section><!-- How it Works block end-->

            <!-- Blog post block -->
            
            <?php /* <section class="blog-post">
            ...
            </section> Blog Post block end-->
                            */ ?>
            <!-- Know more block-->
            
            <section class="padding40" style="background-color: #fff;">
                <div class="container">
                    <h3 class="main-heading">Are You An Expert?</h3>

                    <p class="main-content" style="text-align: center;">Come be a part of our journey, revolutionize taxation, legal  and accounting services.<br> Create a hassle free life for everyone ! </p>
                    <a href="<?php echo base_url(); ?>Expert" class="btn knowmore-btn">Know More...
                        </a>
                </div>
            ...
            <section class="about-us" style="background-color: rgba(186, 186, 186, 0.23)">
                <div class="container">
                    <h1>About Us</h1>
                    ...
                    <p>Visheshagya aims to bring about a paradigm shift in the way professional services for taxation, accounting and legal are rendered to clients!<br> Visheshagya’s vision is to<b class="new"> empower clients</b> by providing easy accessibility, convenience, transparency through technology driven, state of the art professional services and <b class="new">enable experts</b> to adapt to newer & smarter ways of doing & growing business. </p>
            ...
            </section><!-- About Us block end-->
            
            <!-- Featured Block-->
            
            <section class="padding40">
                <div class="container">
                    <h1 class="main-heading">Featured In</h1>
                    <ul id="news">
                   ...
                   <ul id="news">
                    ...
                    <!-- <h1 class="main-heading">For investors</h1>
                   <ul id="news">
                        <li><a target="_blank" href="<?php echo base_url(); ?>assets1/img/investors.pptx">Click here For Dowanloade<img border="0" src="<?php echo base_url(); ?>assets1/img/v2.JPG" alt="" width="104" height="142"></a></li>
