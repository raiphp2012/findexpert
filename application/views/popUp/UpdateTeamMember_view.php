<div id="UpdateTeamMember" class="modal fade modal-login"><form action="<?php echo base_url(); ?>ExpertProfile/UpdateMemberDetails" method="post" class="form-horizontal">
                ...
                <fieldset>
                    <!--<legend>Login</legend>-->
                     <div class="row">                        <div class="col-md-12">                            <div class="form-group">                               
                                    <?php echo form_input(['name' => 'ExpertId', 'type' => 'text','class' => 'form-control']); ?>									 </div>                        </div>                    </div>
                    ...
                    </div>										 <div class="row">                        <div class="col-md-12">                            <div class="form-group">                                    <?php echo form_input(['name' => 'updateExpertPassword', 'type' => 'password', 'id'=>'expertPassword',  'class' => 'form-control', 'placeholder' => 'Password']); ?>                                                         </div>                        </div>                    </div>
                     <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
