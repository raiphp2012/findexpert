            ...
            <div>
                <div class="row">
                    <div class="col-sm-12 transaction-reciept">
						...
						value="<?php echo "Actiontaken-".$txn_id; ?>">
						...
						value="<?php echo $amount; ?>">
                                <input title="TXN_AMOUNT" tabindex="10" type="hidden" name="CALLBACK_URL"
                                                value="<?php echo base_url();?>Ajaxcalls/response_action_taken">
