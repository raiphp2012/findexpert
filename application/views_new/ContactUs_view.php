...
<body>
  <div class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?php echo base_url().'ClientHome';?>"><div class="logo"></div></a>
      </div>
  ...
  <div class="container view-profile width100 pad0">   
    <div class="row table-row  width100">
      <!-- Sidebar START -->
      <div class="col-xs-12 col-sm-4 sidenavDark contact-us">    
         <div class="row">                
          <div class="col-xs-12">
            <h3 class="title">Visheshagya Services Pvt. Ltd.</h3>
            <h4 class="email">E-Mail: support@visheshagya.in</h4>
            <h4 class="contact">Contact No.: 786-2800-600</h4>
            <div>
              <h4 class="head">Head Office(Gurgaon):</h4>
      ...
      <!-- Main Area Start -->
      <div class="col-xs-12 col-sm-8 profile-details-wrapper">
