...
<div id="cancelAppointment" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="container">
                <?php echo form_open(base_url() . 'ClientAppointmentDetails/cancelAppointment', ['class' => 'form-horizontal']) ?>
                <fieldset>
                    <legend>Cancel Appointment</legend>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="inputEmail" class="col-lg-4 control-label">Expert Name</label>
                                <div class="col-lg-7">
