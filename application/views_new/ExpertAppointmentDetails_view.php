                                                  ...
                                                  <div class="databorder">
                                                    ...
                                                    <div class="row datashow">
                                                      <div class="col-md-6 datacol">
                                                        ...
                                                        <input type="button" onclick="startAudioCall('<?php echo date('Y-m-d');?>','<?php echo $appointments->expertMobileNumber; ?>', '<?php echo $appointments->clientMobileNumber; ?>', '<?php echo date('H:i',strtotime($appointments->appointmentStartTime)); ?>', '<?php echo date('H:i',strtotime($appointments->appointmentEndTime)); ?>')" class="btn btn-primary" value="Start Audio">
                                                      </div>
                                                    </div>
                                                    </div>
                                                      <?php
                                                      ...
                                                      <div class="row datashow">
                                                            <div class="col-md-6 datacol">
                                                            <a href="<?php echo $appointments->start_url; ?>"  class="btn btn-success" target="_blank"   onclick="UpdateData('<?php echo  $appointments->appointmentId;?>');">Start Video Call </a>
                                                            <input type="button" onclick="startAudioCall('<?php echo date('Y-m-d');?>','<?php echo $appointments->expertMobileNumber; ?>', '<?php echo $appointments->clientMobileNumber; ?>', '<?php echo date('H:i',strtotime($appointments->appointmentStartTime)); ?>', '<?php echo date('H:i',strtotime($appointments->appointmentEndTime)); ?>')" class="btn btn-primary" value="Start Mobile Call">

                                                            <input type="button" onclick="ddlChange( '<?php echo $appointments->appointmentId; ?>')" class="btn btn-primary" value="Completed">
                                                            </div>
                                                      </div>
                                                      <?php }
                                                      ?>
