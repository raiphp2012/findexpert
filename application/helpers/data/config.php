...
$apiConfig = array(
    ...
    'application_name' => 'Visheshagya', //Example: Vasplus Programming Blog
	
	//The Client ID and Secret are gotten from https://code.google.com/apis/console/
	'oauth2_client_id' => '246852978464-j53ntc1574e3g8m6km9thimr2a9lchel.apps.googleusercontent.com', //This is the Client ID gotten from Google
    'oauth2_client_secret' => 'acMECGTKZbiHYcgocxbWm8wJ', //This is the Client Secret gotten from Google
	'oauth2_redirect_uri' => 'http://www.visheshagya.in/GLogin', //Enter the full URL to gmail/successPage.php file
