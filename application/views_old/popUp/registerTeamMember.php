                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="col-lg-7"> -->
                                    ...
                                    <?php echo form_input(['name' =>'expertName', 'type' => 'text', 'required' => 'true', 'class' => 'form-control', 'placeholder' => 'Your Name']); ?>
                                <!-- </div> -->
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-7"> -->
                                    <div class="input-group">
                                        ...
                                        <?php echo form_input(['name' => 'expertMobileNumber', 'type' => 'text', 'required' => 'true', 'pattern'=>'[1-9]{1}[0-9]{9}', 'class' => 'form-control', 'placeholder' => 'Your Number']); ?>
                                    <!-- </div> -->
                                </div>
                            </div>
                        </div>
