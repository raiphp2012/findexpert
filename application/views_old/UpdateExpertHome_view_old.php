                  ...
                  <div class="dropdown dropdown-lg">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" role="menu">
                      <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                          <label for="contain">Advanced</label>
                          <input class="form-control" type="text" />
                        </div>
                        <button type="button" class="bannerSearchGo btn btn-primary">Search an Expert</button>
                      </form>
                    </div>
                  </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 text-center">
          <div class="service-box">
            ...
            <h3>Global Reach</h3>
            <p class="text-muted">Network without borders Create your global identity Connect & Collaborate with clients globally</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 text-center">
          <div class="service-box">
     ...
     <div class="row">
        <div class="col-lg-4 col-md-6 text-center">
          <div class="service-box">
            <div class="serviceIcon"> 
              <img src="<?php echo base_url(); ?>assets/img/customer.png" alt="Experts"  style="height: 155px;">
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-8 col-md-offset-2">
                            <div class="embed-responsive embed-responsive-16by9 videoBox">
                                <!-- <iframe class="embed-responsive-item" src='https://www.youtube.com/watch?v=0pG1a_BIUP0?modestbranding=0&autohide=1&showinfo=0&controls=0" frameborder="0"' ></iframe>-->
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/7Xx9IONXp8Q?autoplay=0&loop=0&playlist=0pG1a_BIUP0,mUikDhd4QF4,WSYavZAqLvM,TrjGTpaPEa8" frameborder="0" allowfullscreen></iframe>
                            </div>          
                        </div>
                    </div>      
                    <div class="rowGap">&nbsp;</div>
    ...
    <div class="container">
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            ...
            <p>Court proceedings of any type should be avoided at all times. 
            Well-defined contracts will greatly help landlords to convince tenants that they 
            (the landlords) are likely to win the case in court. An eviction cases can last up to 10 or even 20 years.(Legislation) Local laws cover landlord and tenant agreements.
      Many local rent control laws such as the Maharashtra Rent Act 1999, Delhi Rent Act 1995, Tamil Nadu Buildings (Lease and Rent Control) Act 1960, strictly regulate rental agreements that are 12 months or longer in favor of tenants. If the monthly rent payable on a property exceeds Rs3,500 (US$76), the agreement is subject to the Transfer of Property Act (TPA), which assigns the landlord responsibilities including i) disclosure of information regarding material defects in the property and ii) uninterrupted occupation of the 
      property for the agreed period (subject to periodic visits by the landlord for inspection).</p>
      <a href="http://visheshagya.in/blog" style="color:white;"><p>Know More...</p></a>
          ...
          <div class="item">
            ...
            <p>The Indian law of Arbitration and Conciliation act 1996, under section 61 provides the scope and application of conciliation (alternate dispute redressal).
      Interminable, time consuming, complex and expensive Court procedures have led parties to settle their disputes out of the court. It would be the right answer for 
      people who want their disputes to be settled expeditiously and through an 
      option which is cost effective and simple.However;it is non-binding in nature!</p>
      <a href="http://visheshagya.in/blog" style="color:white;"><p>Know More...</p></a>
          </div>
