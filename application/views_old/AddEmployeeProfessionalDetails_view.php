...
<div class="main-content detail-view">
    <div class="detail-view-cont">
        <form class="form-horizontal" method="POST" action="addProfessionalDetails" id="expertSignupForm"name="expertSignupForm" enctype="multipart/form-data" onsubmit="return (submitForm())">
            <fieldset>                                            
                <div id="professionalDataTab">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="expertProfessionalFile" required name="expertProfessionalFile" type="file" class="form-control input-md">
                            </div>
                        </div>                                                    
                        <div class="col-md-12 text-center form-group">								 
                            <button class="btn btn-sm btn-primary" onclick="submitForm()">Add Professional Detail</button>								  
                        </div>
                    </div>
                </div>
            </fieldset>
