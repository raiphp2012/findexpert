...
<html lang="en">
    <head>
        ...
        <style>
           ...
           /* .position-relative {
            ...
            /*.position-relative .slider-arrow{
                position: absolute;
                width: 40px;
                height:40px;
                top:0;
  ...
  <!--       <div class="panel position-relative"> 
            <h1 style="color: #e31e25;font-size: 23px;">Offer of the Mont h</h1> -->
        ...
        <div class="wide">
            ...
            <section id="waitInQueue" class="textcenter padding40" style="background-color: #fff">
                <div class="container">
                    ...
                    <!-- <div class="row">
                        <a href="<?php echo base_url() ?>Searchexpertdetails/clientBookingAppointmentInstant"  class="btn btn-primary btn-lg active" >Consult Immediately</a>
                    </div> -->
                </div>
            </section>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                           ...
                           <div class="fb-page" data-href="https://www.facebook.com/visheshagya" data-tabs="timeline"  data-height="400" data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/visheshagya" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/visheshagya" title="Visheshagya">Visheshagya</a></blockquote></div>
