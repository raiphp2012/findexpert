                ...
                <div class="row">
                    ...
                    <div class="row" style="padding-bottom: 10px;">
                        ...
                        <div class="col-xs-6 col-sm-3">
                            <div class="bannerSquareBox eqHt">
                                <div class="bannerSquareLogo">
                                    <a href="ExpertdetailsTmp"><img src="<?php echo base_url(); ?>assets1/img/logo_law.svg" alt="Lawyer Logo" ></a>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-8 col-md-offset-2">
                            <div class="embed-responsive embed-responsive-16by9 videoBox">
                                <iframe width="860" height="315" src="https://www.youtube.com/embed/4PHPwgMOVwQ?autoplay=0&loop=1&playlist=i8AeakXxufM,RCXUIr5nlHw,9TIpcWA4vE8,Pfx7EYc1ERU" frameborder="0" allowfullscreen></iframe>
                            </div>          
                        </div>
                    </div>      
                    <div class="rowGap">&nbsp;</div>
