...
<html lang="en">
												...
												<div id="StepTab1">
													...
													<div class="col-md-12 form-wrapper">
														...
														<div class="col-md-12 text-center">                    
															 ...
															 {
																?>
																 <a role="button" class="launch-modal btn next-btn" href="#"  data-modal-id="modal-login" data-modal-value="<?php  echo base_url(uri_string()); ?>"> Login to continue <i class="fa fa-hand-o-right"></i></a>
															 <?php   
 ...
 ?>
	...
	<script src="<?php echo base_url(); ?>assets/js/site.js"></script><!--         <script src="<?php echo base_url(); ?>assets/js/site.js"></script> -->
